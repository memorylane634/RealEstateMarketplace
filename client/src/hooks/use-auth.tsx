...
type RegisterData = {
  ...
  firstName: string;
  lastName: string;
  userType: "wholesaler" | "cash_buyer";
};
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (user: UserWithoutPassword) => {
      ...
      toast({
        ...
        description: "Welcome back to QuickDeals!",
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  const registerMutation = useMutation({
    ...
    onSuccess: (user: UserWithoutPassword) => {
      ...
      toast({
        ...
        description: "Welcome to QuickDeals! Please complete your verification to unlock all features.",
      });
    },
    onError: (error: Error) => {
      toast({
